<template>
  <div class='toddler' @mousemove.stop.prevent='change' @mouseleave.stop.prevent='out'>
    <div class="toddler__line" ref='line'>
      <div class="toddler__handle" @mousedown.stop.prevent="on" @mouseup.stop.prevent="off" :style='{"left": value / max * 100 + "%"}'></div>
      <div class="toddler__value" :style='{"left": value / max * 100 + "%"}'>{{value | toFixed}}</div>
      <div class="toddler__before" :style='{"width": value / max * 100 - 1 + "%"}'></div>
      <div class="toddler__after" :style='{"width": (100 - value / max * 100) - 1 + "%"}'></div>
    </div>
